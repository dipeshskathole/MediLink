...
public class PharmacyMedicine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGoToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               startActivity(new Intent(PharmacyMedicine.this, CartBuyMedicineActivity.class));
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PharmacyMedicine.this, HomeActivity.class));
            }
        });
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent it = new Intent(PharmacyMedicine.this, PharmacyMedicineDetails.class);
