...
public class DiagnosticsTestBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diagnostics_test_book);
        ...
        btnBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity( new Intent(DiagnosticsTestBookActivity.this, HomeActivity.class));
            }
        });
    }
}